...
import { Microsoft } from '../data/themes.json';

import styled from 'styled-components';
import { PageAuthor, PageContainer, PageImage, PageTitle } from '../styles';

const files = Object.entries(Microsoft.props);
...
const MicrosoftComponent = () => {
  ...
  return (
    <Layout>
      <SEO title="Microsoft" />
      <PageContainer>
        <PageImage src={`/${Microsoft.backgroundUrl}`} />
...
export default memo(MicrosoftComponent);
